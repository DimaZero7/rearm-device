    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(upload_to=apps.catalog.models.category_img_name, verbose_name='Картинка категории')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(help_text='500x500px', upload_to=apps.catalog.models.manufacture_img_name, verbose_name='Логотип компании')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', models.ImageField(upload_to=apps.catalog.models.product_img_name)),
